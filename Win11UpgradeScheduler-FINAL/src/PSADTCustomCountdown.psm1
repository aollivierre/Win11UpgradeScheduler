...
function Show-CustomCountdownDialog {
    ...
    $buttonStartNow.Location = New-Object System.Drawing.Point(120, 155)
    ...
    $buttonClose.Location = New-Object System.Drawing.Point(230, 155)
    ...
    # Add controls
    $form.Controls.AddRange(@($labelMessage, $labelCountdown, $labelStatus, $buttonStartNow, $buttonClose))
