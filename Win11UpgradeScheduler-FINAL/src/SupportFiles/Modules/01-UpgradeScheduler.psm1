...
function New-UpgradeSchedule {
    ...
    # Create task action using wrapper script directly
    # The wrapper script now handles SYSTEM context detection and Execute-ProcessAsUser internally
    Write-SchedulerLog -Message "Creating scheduled task with wrapper script (handles UI context automatically)" -Severity Information
