...
'@
    ...
    $scheduleButton.Add_Click({
        if ($tonight8PM.IsChecked) {
            $script:selectedSchedule = "Tonight - 8PM"
        }
        elseif ($tonight10PM.IsChecked) {
            $script:selectedSchedule = "Tonight - 10PM"
        }
        elseif ($tonight11PM.IsChecked) {
            $script:selectedSchedule = "Tonight - 11PM"
        }
        elseif ($tomorrowMorning.IsChecked) {
            $script:selectedSchedule = "Tomorrow - Morning"
        }
        elseif ($tomorrowAfternoon.IsChecked) {
            $script:selectedSchedule = "Tomorrow - Afternoon"
        }
        elseif ($tomorrowEvening.IsChecked) {
            $script:selectedSchedule = "Tomorrow - Evening"
        }
